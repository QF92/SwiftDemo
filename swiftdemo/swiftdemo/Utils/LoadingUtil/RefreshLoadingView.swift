...
typealias RefreshLoadingViewAnimationStopClose = () -> ()
class RefreshLoadingView: UIView {

    var clouse: RefreshLoadingViewAnimationStopClose?
        ...
        func configurePath() {
            ...
            backgroundShapeLayer.strokeColor = RGBAColor(205, 205, 205).cgColor
        ...
        func configureAnimation() {
            progressShapeLayer.strokeColor = DealistConfig.share.mainColor.cgColor
            let animation = CABasicAnimation(keyPath: "transform.rotation.z")
            animation.repeatCount = DealistConfig.share.maxShowInterval
    ...
    extension RefreshLoadingView: CAAnimationDelegate {
