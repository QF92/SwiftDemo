...
class LoadingFreeUtil: NSObject {
    lazy var bottomView: UIView = {
            let bottom = UIView()
            bottom.frame = CGRect.zero
            return bottom
        }()
        lazy var progressView: RefreshLoadingView = {
            let progress = RefreshLoadingView.init(frame: CGRect.zero)
        ...
        lazy var titleLabel: UILabel = {
            ...
            title.textColor = RGBAColorAlpha(96, 102, 111, 1)
            title.text = "加载中..."
