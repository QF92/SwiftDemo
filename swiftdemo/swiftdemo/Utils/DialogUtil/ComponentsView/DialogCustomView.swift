...
typealias DialogCustomViewClouse = (UIView?)->()

class DialogCustomView: UIView {
    ...
    lazy var msgLabel: UILabel = {
        ...
        open var leftHandler: DialogCustomViewClouse?
        open var rightHandler: DialogCustomViewClouse?
