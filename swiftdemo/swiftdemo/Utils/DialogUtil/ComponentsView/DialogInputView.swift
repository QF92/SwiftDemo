...
typealias DialogInputViewClouse = (String)->()
class DialogInputView: UIView {
   ...
   lazy var msgLabel: UILabel = {
    ...
    lazy var textView: DialogTextView = {
        let text = DialogTextView.init(frame: CGRect.zero)
        text.placehoder = "请输入..."
    ...
    open var leftHandler: DialogInputViewClouse?
    open var rightHandler: DialogInputViewClouse?
    ...
    @objc func clickLeftbtn() {
        DialogManager.share.id_resetInputProps()
