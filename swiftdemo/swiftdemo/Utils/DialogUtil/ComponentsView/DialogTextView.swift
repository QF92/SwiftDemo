...
typealias DialogTextViewTextDidChangeClouse = (CGFloat) -> ()
...
class DialogTextView: UITextView {
    ...
    var placehoder: String? {
        ...
        var textChangeClouse: DialogTextViewTextDidChangeClouse?
        ...
        func setupTextView(){
            ...
            self.maxLength = DialogManager.share.maxLength
            self.onlyNumberAndPoint = DialogManager.share.onlyNumberAndPoint
            self.onlyNumber = DialogManager.share.onlyNumber
            self.allowEmoji = DialogManager.share.allowEmoji
            self.pointLength = DialogManager.share.pointLength
            self.predicateString = DialogManager.share.predicateString
        }
        //MARK - 监听文字改变
