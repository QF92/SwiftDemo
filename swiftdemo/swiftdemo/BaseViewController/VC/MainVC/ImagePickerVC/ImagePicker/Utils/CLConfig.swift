...
// 本地化
let sureStr = NSLocalizedString("完成", comment: "")
let resetStr = NSLocalizedString("重置", comment: "")
let previewStr = NSLocalizedString("预览", comment:"预览")
let cancelStr = NSLocalizedString("取消", comment: "")
let photoStr = NSLocalizedString("相册", comment: "")
let errorStr = NSLocalizedString("错误", comment: "")
let editorStr = NSLocalizedString("编辑", comment: "")
let playErrorStr = NSLocalizedString("播放出错", comment: "")
let maxPhotoCountStr = NSLocalizedString("您最多只能选择%zd张照片", comment: "")
let knowStr = NSLocalizedString("知道了", comment: "")
let imageAndVideoOnlyOneStr = NSLocalizedString("视频文件和图片文件只能选择1种", comment: "")

let graffitiStr = NSLocalizedString( "涂鸦", comment: "")
let eraserStr = NSLocalizedString( "橡皮擦", comment: "")
let mosaicStr = NSLocalizedString( "马赛克", comment: "")
let undoStr = NSLocalizedString( "上一步", comment: "")
let redoStr = NSLocalizedString( "下一步", comment: "")

let photoLimitStr = NSLocalizedString( "照片访问受限", comment: "")
let clickSetStr = NSLocalizedString( "点击“设置”，允许访问您的照片", comment: "")
let setStr = NSLocalizedString( "设置", comment: "")

let cameraLimitStr = NSLocalizedString( "相机访问受限", comment: "")
let clickCameraStr = NSLocalizedString( "点击“设置”，允许访问您的相机", comment: "")

let tackPhotoStr = NSLocalizedString( "拍照", comment: "")
let chooseStr = NSLocalizedString( "从手机相册选择", comment: "")

let favStr = NSLocalizedString( "收藏", comment: "")
let videoStr = NSLocalizedString( "视频", comment: "")
let allPStr = NSLocalizedString( "所有照片", comment: "")
let rencentStr = NSLocalizedString( "最近添加", comment: "")
let shotStr = NSLocalizedString( "屏幕快照", comment: "")
let selfStr = NSLocalizedString( "自拍", comment: "")
let delectStr = NSLocalizedString( "最近删除", comment: "")
// 本地化
