...
class CLPreviewVideoCell: UICollectionViewCell {
    ...
    @objc lazy var playBtn: UIButton = {
        let btn = UIButton.init(frame: CGRect(x: 0.5*(self.id_width-80), y: 0.5*(self.id_height-80), width: 80, height: 80))
    ...
    override func layoutSubviews() {
        ...
        self.iconView.frame = CGRect(x: 0, y: 0, width: self.id_width, height: self.id_height)
        self.playBtn.frame = CGRect(x: 0.5*(self.id_width-80), y: 0.5*(self.id_height-80), width: 80, height: 80)
