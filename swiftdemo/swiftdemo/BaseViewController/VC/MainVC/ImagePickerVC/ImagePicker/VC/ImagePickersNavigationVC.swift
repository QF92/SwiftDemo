//
//  ImagePickersNavigationVC.swift
//  swiftdemo
//
...
typealias ChooseImageCompleteClouse = (Array<PHAsset>,UIImage?)->()

class ImagePickersNavigationVC: UINavigationController {

   @objc static let share = ImagePickersNavigationVC()
        
    @objc var imageCompleteClouse: ChooseImageCompleteClouse?
    ...
    func initWith(
            ...
            statusBarType:ImagePickerStatusBarType,
            didChooseImageSuccess:@escaping (Array<PHAsset>,UIImage?)->()) -> ImagePickersNavigationVC {
            ...
            let vc = ImagePickersNavigationVC.init(rootViewController: albumVC)
        ...
        deinit {
            print("ImagePickersNavigationVC释放")
    ...
    //MARK: - 相册列表控制器
    class CLImageAlbumPickerController: BaseImagePickerViewController {
        ...
        // 单选状态的类型
        var singleType: ImagePickerType?
        // 图片裁剪比例
