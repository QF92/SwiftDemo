...
class LimitsTools: NSObject {
    ...
    static let share = LimitsTools()
        ...
        func showCameraAlert() {
            ...
            DialogTool.id_show(title: cameraLimitStr, msg: clickCameraStr, leftActionTitle: "取消", rightActionTitle: "设置", leftHandler: {
        ...
        func showLibraryAlert() {
            ...
            DialogTool.id_show(title: libraryLimitStr, msg: clickLibraryStr, leftActionTitle: "取消", rightActionTitle: "设置", leftHandler: {
