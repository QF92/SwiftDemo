...
public class EmptyView: UIView {
    ...
    public static var mainColor = UIColor.colorFromHex(0x0D7AFF)
        ...
        func configureView() {
            ...
            actionButton.backgroundColor = EmptyView.mainColor
        ...
        //MAKR: - Public Methods
        public class func create() -> EmptyView {
            let emptyView = EmptyView()
            return emptyView
        }
        
        public func setOperatorAction(_ action: @escaping OperatorAction) -> EmptyView {
            self.action = action
            return self
        }
        ...
        public func custom(image: UIImage? = nil,
                           title: String? = nil,
                           detail: String? = nil,
                           buttonText: String? = nil) -> EmptyView {
        ...
        public func configStyle(_ style: Style? = .normal) -> EmptyView {
