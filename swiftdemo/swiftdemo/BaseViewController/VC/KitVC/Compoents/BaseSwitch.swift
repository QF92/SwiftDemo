...
import UIKit
public typealias SwitchValueChangeClouse  = (_ value: Bool) -> Void

class BaseSwitch: UIControl {

    public var valueChange : SwitchValueChangeClouse?
        public var id_animateDuration : Double = 0.3
        
        public var id_lineWidth : CGFloat = 1
        
        public var id_mainColor : UIColor = (DealistConfig.share.mainColor) {
            didSet {
                setUpView()
            }
        }
