...
public typealias SelectViewTitleClickClosure = (Int) -> Void
...
public enum SelectViewIndicatorType {
    case line
    case ellipse
}
...
class BaseSelectView: UIView {
    ...
    let segmentedView = JXSegmentedView()
        ...
        public var titleClickClosure: SelectViewTitleClickClosure?
        open var numberStringFormatterClosure: ((Int) -> String)?

        /// 初始化类型
        public var id_type: SelectViewType = SelectViewType.normal {
            didSet {
                if id_type == .normal {
        ...
        /// 指示器的颜色
        public var id_indicatorColor: UIColor = DealistConfig.share.mainColor {
            didSet {
        ...
        /// 选中状态的颜色
        public var id_titleSelectedColor: UIColor = DealistConfig.share.mainColor {
            didSet {
        ...
        /// 指示器的类型，横线、椭圆
        public var id_indicatorType: SelectViewIndicatorType = .line {
            didSet {
        ...
        /// 红点的颜色
        open var id_dotColor = DealistConfig.share.mainColor {
            didSet {
        ...
        public override init(frame: CGRect) {
            ...
            // 初始化颜色
            self.dotsDataSource.dotColor = DealistConfig.share.mainColor
            self.dotsDataSource.titleSelectedColor = DealistConfig.share.mainColor

            self.numberDataSource.titleSelectedColor = DealistConfig.share.mainColor
            self.numberDataSource.numberBackgroundColor = DealistConfig.share.mainColor

            self.segmentedDataSource.titleSelectedColor = DealistConfig.share.mainColor
            
            self.indicator.indicatorColor = DealistConfig.share.mainColor
            self.ellipseIndicator.indicatorColor = DealistConfig.share.mainColor
    ...
    extension BaseSelectView: JXSegmentedViewDelegate {
