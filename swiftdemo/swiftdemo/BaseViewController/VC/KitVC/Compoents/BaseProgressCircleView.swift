...
import UIKit
public enum ProgressCircleViewType {
    case circle
    case pie
}

class BaseProgressCircleView: UIView {
    ...
    /// value的范围是0-100
        ...
        /// 颜色
        public var id_fillColor: UIColor = (DealistConfig.share.mainColor) {
            didSet {
                self.setNeedsDisplay()
            }
        }
        ...
        /// 类型
        public var id_type: ProgressCircleViewType = .circle {
            didSet {
                self.setNeedsDisplay()
            }
        }
