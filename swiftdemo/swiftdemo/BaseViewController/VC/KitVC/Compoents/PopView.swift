...
public enum PopViewArrowPosition {
    case left
    case center
    case right
    case custom  // 自定义
...
class PopView: UIView {
    ...
    public var popMenuDidDismissed: PopMenuDidDismissedClouse?
        ...
        public var id_arrowPosition: PopViewArrowPosition = .right
        ...
        public static func `init`(contentView: UIView) -> PopView {
            let pop = PopView.init(frame: CGRect.zero, contentView: contentView)
            return pop
        }
