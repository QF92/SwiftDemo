...
class BaseSearchBar: UIView, UISearchBarDelegate {
    ...
    /// 右边按钮的文字颜色
    public var id_cancelButtonTitleColor = RGBAColor(95,95,95) {
        didSet {
            let btn = self.search.value(forKey: "cancelButton") as! UIButton
    ...
    /// 搜索容器的背景色
    public var id_containerBgColor = RGBAColor(239, 239, 244) {
        didSet {
