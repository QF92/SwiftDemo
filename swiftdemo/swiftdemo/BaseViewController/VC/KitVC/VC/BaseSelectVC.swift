...
class BaseSelectVC: BaseViewController {
    ...
    lazy var scrollView: UIScrollView = {
        ...
        lazy var selectView1: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: 60, width: KScreenWidth, height: 50))
            select.id_titles = ["猴哥", "青蛙王子", "旺财", "粉红猪", "喜羊羊", "黄焖鸡", "小马哥", "牛魔王", "大象先生", "神龙"]
            select.id_indicatorWidth = 20
            return select
        }()
        
        lazy var selectView2: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.selectView1.frame.maxY + 30, width: KScreenWidth, height: 50))
            select.id_titles = ["猴哥", "青蛙王子", "旺财", "粉红猪", "喜羊羊", "黄焖鸡", "小马哥", "牛魔王", "大象先生", "神龙"]
            select.id_indicatorEqualWidth = true
            return select
        }()
        
        lazy var selectView3: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.selectView2.frame.maxY + 30, width: KScreenWidth, height: 50))
            select.id_titles = ["猴哥", "青蛙王子", "旺财", "粉红猪", "喜羊羊", "黄焖鸡", "小马哥", "牛魔王", "大象先生", "神龙"]
            select.id_indicatorEqualWidth = true
        ...
        lazy var selectView4: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.selectView3.frame.maxY + 30, width: KScreenWidth, height: 50))
            select.id_titles = ["猴哥猴哥猴哥猴哥猴哥猴哥猴哥猴哥", "青蛙王子", "旺财", "粉红猪"]
            select.id_titleNumberOfLines = 2
            return select
        }()
        lazy var selectView5: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.selectView4.frame.maxY + 30, width: KScreenWidth, height: 50))
        ...
        lazy var selectView6: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.selectView5.frame.maxY + 30, width: KScreenWidth, height: 50))
            select.id_titles = ["猴哥", "青蛙王子", "旺财", "粉红猪"]
        ...
        lazy var selectView7: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.selectView6.frame.maxY + 30, width: KScreenWidth, height: 50))
        ...
        lazy var selectView8: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.btn1.frame.maxY + 30, width: KScreenWidth, height: 50))
            select.id_type = .dots
            select.id_titles = ["猴哥", "青蛙王子", "旺财", "粉红猪", "喜羊羊", "黄焖鸡", "小马哥"]
            select.id_indicatorEqualWidth = true
        ...
        lazy var selectView9: BaseSelectView = {
            let select = BaseSelectView.init(frame: CGRect(x: 0, y: self.btn2.frame.maxY + 30, width: KScreenWidth, height: 50))
            select.id_type = .dots
            select.id_titles = ["猴哥", "青蛙王子", "旺财", "粉红猪", "喜羊羊", "黄焖鸡", "小马哥"]
            select.id_indicatorEqualWidth = true
