...
/// QFMultipartData for upload datas, eg: images/photos
public class QFMultipartData {
    ...
    convenience init(data: Data, name: String, fileName: String, type: QFDataMimeType) {
